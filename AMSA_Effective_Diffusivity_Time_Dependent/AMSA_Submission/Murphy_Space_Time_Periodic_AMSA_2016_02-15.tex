...
with $\vecpsi\cdot\vecpsi=|\vecpsi|^2$. We stress that all quantities  
...
\end{align}
%
where $\langle f,h\rangle_1=\langle\bnabla f\cdot\bnabla h\rangle$ is a Sobolev-type
...
\begin{align}\label{eq:Function_Space_Scalar}
  ...
  %\langle \psi,g\rangle_1=\left\langle\overline{\bnabla \psi}\cdot\bnabla g\right\rangle,
\end{align}
%
Recalling that $\vecpsi\cdot\vecvarphi=\vecpsi^\dagger\vecvarphi$, the sesquilinear
$\Hs$--inner-product is given by $\langle\psi,\varphi\rangle_1=\left\langle\bnabla \psi\cdot\bnabla \varphi \right\rangle$ with associated norm
...
\end{align}
%
where we have defined $A=(-\Delta)^{-1}(\partial_t-\vecu \cdot\bnabla)$. The
...
\begin{theorem}\label{thm:Integral_Reps}
  The operator $A=(-\Delta)^{-1}(\partial_t-\vecu\cdot\bnabla)$ displayed in
...
$[\vecu(t,\cdot)\cdot\bnabla]:\Hs^1_{\Vc}\to\Hs_{\Vc}$, while
...
%$\epsilon>\|f_n-f_m\|_1=\|\bnabla \Delta^{-1}\Delta f_n-\bnablaf_m\|=\|\bGamma\bnabla f_n-\bnablaf_m\|$
%
...
f\|^2=\langle\bnabla f\cdot\bnabla f\rangle=\|f\|_1^2<\infty$. Consequently, for every   
...
$\|f\|_1^2=\langle\vecpsi\cdot\vecpsi\rangle=\|\vecpsi\,\|^2<\infty$ so that
...
%   \langle\varphi_l,\varphi_m\rangle_1=\langle\bnabla \varphi_l\cdot\bnabla \varphi_m\rangle=\delta_{lm}.
% \end{align}
% %
