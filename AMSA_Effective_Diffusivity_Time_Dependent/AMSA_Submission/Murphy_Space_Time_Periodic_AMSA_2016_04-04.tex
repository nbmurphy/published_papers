...
in the present context, periodic boundary conditions on
...
$\Hs^{1,2}_{\Vc}\cup\mathbb{C}$ we have $g_j=(-\Delta)^{-1}u_j\in\Fs$. Since
...
simplicity. We also denote by $\langle\cdot,\cdot\rangle_\times$ the sesquilinear inner-product
...
$\|\vecpsi\|_{\times}=\langle\vecpsi,\vecpsi\rangle_\times^{1/2}$. Recall that the Sobolev
...
\begin{align}\label{eq:Gamma_Proj_H12}
  ...
  \equiv\lim_{n\to\infty}\langle\bnabla(-\Delta)^{-1}(-\Delta)f_n,\bpsi\rangle_\times
...
by $\langle\cdot,\cdot\rangle$ the sesquilinear inner-product associated with the Hilbert
space $\Hc$, given by
$\langle\vecpsi,\vecvarphi\rangle=\langle\vecpsi\bcdot\vecvarphi\rangle$, 
...
$\overline{\vecvarphi}$ denotes component-wise complex conjugation,
with $\vecpsi\bcdot\vecpsi=|\vecpsi|^2$. The norm $\|\cdot\|$ induced by
this inner-product is given by $\|\vecpsi\|=\langle\vecpsi,\vecpsi\rangle^{1/2}$. In
...
\begin{align}\label{eq:Functional_Rep}
  \langle u_j\,\chi_k\rangle&=-\langle[\bnabla\bcdot\bsig\bnabla\chi_j]\,\chi_k\rangle
       ...
       &=\varepsilon\langle\bnabla\chi_j,\bnabla\chi_k\rangle
         +\langle\bGamma\Sb\bGamma\bnabla\chi_j,\bnabla\chi_k\rangle.
         \notag
\end{align}
%
...
\begin{align}\label{eq:StoA}
  %\langle\Ab\bnabla\chi_j,\bnabla\chi_k\rangle=
                              \langle\bGamma\Sb\bGamma\bnabla\chi_j,\bnabla\chi_k\rangle
                             =\langle\bGamma\Sb\bnabla\chi_j,\bnabla\chi_k\rangle
                             =\langle\Sb\bGamma\bnabla\chi_j,\bnabla\chi_k\rangle
                             =\langle\Sb\bnabla\chi_j,\bnabla\chi_k\rangle.
\end{align}
% 
...
%
\begin{align}
  \|\bGamma\Hm\bGamma\bpsi\|
  =\|\bGamma\Hm\bnabla f\|
  =\|\bnabla(-\Delta)^{-1}[\vecu\bcdot\bnabla f]\|
