...
\received{\sday{3} \smonth{1} \syear{2008}}
...
\begin{table}
\centering
\caption{Parameter sets used by Bajpai \& Reu\ss are not detailed sufficiently to permit a similar analysis}\label{parset}
\begin{tabular}{lrll}
\hline
