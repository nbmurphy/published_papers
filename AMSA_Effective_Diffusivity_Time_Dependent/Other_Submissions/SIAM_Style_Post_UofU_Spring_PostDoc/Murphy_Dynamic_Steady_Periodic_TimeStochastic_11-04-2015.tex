...
% siamltex1213 already supplies graphics, but only in PostScript, not PDF!
\usepackage{amssymb}
\usepackage{amsmath}
\usepackage{amsfonts}
\usepackage{mathrsfs}
% NOT FOR siamltex1213 class: \usepackage[pdftex]{graphicx}
...
\footnotetext[1]{University of California at Irvine, Department of Mathematics, 340
...
\thispagestyle{plain}
\markboth{N. B. Murphy et al.}{Spectral analysis of
  advection-diffusion by dynamic flows}
