...
\end{align}
%
where the velocity field $\vecu$, satisfying $\bnabla\bcdot\vecu=0$,
and the initial density $\phi_0(\vecx)$ are given. In
equation~\eqref{eq:ADE}, $\varepsilon>0$, $d$ is the spatial dimension of the
...
%,~\eqref{eq:Djk}, and~\eqref{eq:Periodic_Cell_Prob}
