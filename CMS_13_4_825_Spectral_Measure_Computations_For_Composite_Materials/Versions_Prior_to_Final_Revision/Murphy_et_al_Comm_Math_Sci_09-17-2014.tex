...
connectivity is encoded by spectral gaps in the measures at the spectral endpoints
...
modifications in the theory. In Section~\ref{sec:Finite_Lattice_Setting}, we develop a mathematical
framework for the \emph{finite} lattice setting, leading to integral 
representations for the effective parameters, summarized in Theorem~\ref{thm:Discrete_Spectral_Theorem_ACM}, which are analogous to that
...
framework. Toward this goal, in Section~\ref{sec:Unification_finite_infinite} we provide a novel formulation
...
\eqref{eq:Proj_rep_Ef_Jf} exactly as in Section~\ref{sec:Continuum_Setting}.  
