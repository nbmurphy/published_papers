...
two-phase conductive media in the continuum \cite{Golden:CMP-473} and
lattice \cite{Bruno:JSP-365,Golden:CMP-467}
settings, yielding Stieltjes integral representations for the
effective conductivity and resistivity tensors. In Section
\ref{sec:Continuum_Setting} we review and extend 
the ACM for the continuum setting, while the
lattice setting is reviewed in
Section \ref{sec:Lattice_Setting}. The mathematical framework
underlying the \emph{infinite} lattice setting, discussed in Section
...
formulation of the ACM for the finite lattice setting, which is discussed
...
$\vec{J}$ \cite{Murphy:JMP:063506,Fannjiang:SIAM_JAM:333}         
%
...
of the specific form of the bijection $\Theta$ of equation
...
easily verified that $\Gamma$ is invariant under this mapping. Similarly,
