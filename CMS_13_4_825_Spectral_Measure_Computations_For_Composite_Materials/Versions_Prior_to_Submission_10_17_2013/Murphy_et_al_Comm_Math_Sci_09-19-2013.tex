...
$\int_0^1R(d\lambda)=I$, where $I$ is the identity operator on
$\mathbb{R}^d$. Moreover, recall that the associated operator $R(\lambda)$ 
...
\end{align}
%
where $R_i^{\,\Pi_1}=\vec{u}_i^{\,\Pi_1}(\vec{u}_i^{\,\Pi_1})^T$,
...
$R_i^{\,\Pi_1}\hat{e}_k^{\,\Pi_1}\cdot\hat{e}_k^{\,\Pi_1}
=R_i^{\,\Pi_1}\hat{e}_k^{\,\Pi_1}\cdot R_i^{\,\Pi_1}\hat{e}_k^{\,\Pi_1}$. Therefore,
...
approximately zero.
%Please note the scales of the axes.  
