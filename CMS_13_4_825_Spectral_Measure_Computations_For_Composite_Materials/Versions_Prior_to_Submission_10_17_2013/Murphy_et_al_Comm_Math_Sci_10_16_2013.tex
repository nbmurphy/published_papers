...
Homogenization for \emph{two-component} media in the
...
analytic continuation method (ACM) is based on the spectral theorem
...
with these random operators, which depend only on the composite
