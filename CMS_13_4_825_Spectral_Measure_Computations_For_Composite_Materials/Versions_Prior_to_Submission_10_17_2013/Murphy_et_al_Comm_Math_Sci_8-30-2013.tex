...
the presentation of the method and to make this manuscript as self
contained as possible, we have placed many of the technical
...
fields, and vice versa \cite{MILTON:2002:TC}. In view of equation
\eqref{eq:Curl_2D}, in \emph{two dimensions} it is natural to define
the curl operator by $\vec{\nabla}\times=\vec{\nabla}\cdot R=[ - \partial_2 \ \partial_1]$ so that on
$\mathbb{N}_L$ we have 
%
\begin{align}
...
for elements of $\mathscr{D}_i$ \cite{Golden:CMP-467}. The closed subset
