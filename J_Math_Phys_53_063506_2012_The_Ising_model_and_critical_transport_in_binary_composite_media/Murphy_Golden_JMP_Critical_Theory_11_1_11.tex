...
\begin{abstract}
%
We present here a general critical theory for transport in binary
composite media, holding for
%both
lattice and continuum percolation
models in the static and frequency dependent (complex) quasi--static
...
characterization of criticality in the Ising model, we show that the
onset of criticality in transport coincides with the collapse of
spectral gaps and the formation of delta function components in
underlying spectral measures. Our results are formulated in terms of 
classical conductive and superconductive random media. Although, the underlying
...
conductivity, extend our results to all of these systems.    
%
\end{abstract}
