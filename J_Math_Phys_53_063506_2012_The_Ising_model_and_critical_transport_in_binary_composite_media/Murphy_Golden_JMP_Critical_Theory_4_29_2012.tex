...
and $\alpha$, the resultant scaling relations which link the two sets of critical
exponents are in agreement with the seminal paper by A. L. Efros and
B. I. Shklovskii \cite{Efros:PSSB-303}. 
...
While in general the spectrum of $\mu$ and $\alpha$  
...
\cite{Golden:CMP-467,Rudin:87}. While in general, the spectrum actually extends
