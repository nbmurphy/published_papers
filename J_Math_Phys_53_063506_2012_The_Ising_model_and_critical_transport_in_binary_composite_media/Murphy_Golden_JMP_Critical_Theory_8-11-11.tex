...
% %
% \begin{align}
%   \mu(v)+\tilde{\alpha}(v)&=\frac{1}{\pi}\lim_{\epsilon\downarrow 0}\text{Im}
%         \left[ \frac{-v+\I\epsilon}{v^2+\epsilon^2}
%           \left(\text{Re}\,\tilde{G}(v+\I\epsilon)+\I\,\text{Im}\,\tilde{G}(v+\I\epsilon)
%           \right)\right]\\
%        &=\frac{1}{\pi}\lim_{\epsilon\downarrow 0}
%         \left[\frac{\epsilon}{v^2+\epsilon^2}\text{Re}\,\tilde{G}(v+\I\epsilon) 
%           -\frac{v}{v^2+\epsilon^2}\text{Im}\,\tilde{G}(v+\I\epsilon)
%           \right]\notag \\
%           &:= \frac{1}{v}\tilde{\alpha}(v)-\varrho(v),\notag
%   \quad \varrho(v):=-\frac{1}{\pi}\lim_{\epsilon\downarrow 0}
%   \frac{\epsilon}{v^2+\epsilon^2}\text{Re}\tilde{G}(v+\I\epsilon).\notag 
% \end{align}
% %
% Thus,
%
...
% imply equation \eqref{eq:Measure_consistentcy_condition} and demonstrate
