...
extend the results pertaining to each system to the quasi--static
regime, where the material contrast parameter becomes complex. Under a
...
completely determined by only (two) parameters. We also provide a
general proof of the fundamental assumption underlying Golden's
original work: the phase transition is due to the formation of delta
function components in the underlying spectral measures, at the
spectral endpoints. More specifically, we show that the onset of the
...
$\{0,1\}$ which links the measures $\mu$ and $\alpha$. This result demonstrates
that, for percolation models, the onset of the phase transition (the
formation of these delta components) occurs \emph{precisely} at the
...
measures $\phi$ and $\ph$, as the result involving $\tilde{\phi}$ and
$\check{\phi}$ follow from the symmetries in equations
...
sign (\cite{Folland:95} Theorem 2.27). We therefore have the following corollary:
%-----------------------------------------------------------------------------------
\begin{corollary}\label{cor:h_diff_commutation}
...
\end{align}
%
which implies that $W_0=-w(0)$ $\Box$.
