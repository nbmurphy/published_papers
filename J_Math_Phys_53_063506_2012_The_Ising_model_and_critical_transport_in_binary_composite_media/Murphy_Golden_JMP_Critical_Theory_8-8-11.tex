...
%   \\ \notag
%   %%%%%%%
%    &\frac{\partial^n\tilde{g_r}}{\partial h^n}+n\frac{\partial^{n-1}\check{g}_r}{\partial h^{n-1}}
%   +h_r\frac{\partial^n\hat{g}_r}{\partial h^n}-h_i\frac{\partial^n\check{g}_i}{\partial h^n}=0,
%   \quad n\geq1, \\
% %  
%   &\frac{\partial^n\tilde{g_i}}{\partial h^n}+n\frac{\partial^{n-1}\check{g}_i}{\partial h^{n-1}}
%   +h_r\frac{\partial^n\hat{g}_i}{\partial h^n}+h_i\frac{\partial^n\check{g}_r}{\partial h^n}=0,
%   \quad n\geq1,
% \end{align}
% %
