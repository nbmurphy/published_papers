...
system. Moreover, we extend these results to the frequency dependent
quasi--static regime, 
...
properties of $\mu$ and $\alpha$, we link these two sets of scaling
relations. Thereby showing that the scaling relations of both systems
are determined by only (two) critical exponents. We also provide 
...
\includegraphics[width=19pc]{2-3-d_Random_Resistor_Networks.eps}%
