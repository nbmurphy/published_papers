\message{ !name(Murphy_Golden_JMP_Critical_Theory_11_8_11.tex)}
\message{ !name(Murphy_Golden_JMP_Critical_Theory_11_8_11.tex) !offset(-2) }
...
of the key result of this section, which generalizes a heuristic
result in \cite{}. It is worth mentioning that equation
...
\message{ !name(Murphy_Golden_JMP_Critical_Theory_11_8_11.tex) !offset(-2911) }
